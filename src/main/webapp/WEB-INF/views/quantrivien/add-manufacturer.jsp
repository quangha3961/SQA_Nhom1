				...
				<div class="form-search">
					<div class="col-12">
						<div class="card mt-5">
							...
							<div class="card-body">
								<h4 class="header-title">Thêm mới nhà xuất bản</h4>
								<sf:form modelAttribute="addCate" class="needs-validation"
									novalidate="" action="${base }/admin/manufacturer/adds"
									...
									<div class="form-row">
										...
										<div class="col-md-4 mb-3">
											<label for="validationCustom02">Tên nhà xuất bản</label>
									...
									<div class="form-row">
										<div class="col-md-6 mb-3">
											...
											<sf:textarea autocomplete="off" path="address" type="text"
