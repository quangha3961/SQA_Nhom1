...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <!-- page title area end -->
        <form class="list" action="${base }/admin/manufacturer/list" method="get">
                ...
                <div class="card-body"
                    ...
                    <div style="display: flex; padding-right: 15px">
                        ...
                        <select class="form-control" name="id" id="id"
                            ...
                            <c:forEach items="${manufacturer}" var="manufacturers">
            ...
            <div class="single-table"
                ...
                <div class="table-responsive">
                    <table class="table text-center">
                        ...
                        <tbody>
                        <c:forEach items="${withPaging.data}" var="manufacturers"
                                   varStatus="loop">
                            <tr>
